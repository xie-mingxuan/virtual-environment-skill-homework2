// var ZLMRTCClient = (function (exports) {
  ...
  const Events$1 = {
    WEBRTC_REQUEST_ERROR: "WEBRTC_REQUEST_ERROR",
  ...
  var rtcpeerconnection = function (window, edgeVersion) {
    ...
    RTCPeerConnection.prototype.setRemoteDescription = function (description) {
      ...
      sections.forEach(function (mediaSection, sdpMLineIndex) {
        ...
        if (!rejected) {
          ...
          remoteDtlsParameters = sdp.getDtlsParameters(
            mediaSection,
            sessionpart
          );
    ...
    RTCPeerConnection.prototype.createAnswer = function () {
      ...
      var mediaSectionsInOffer = sdp.getMediaSections(pc._remoteDescription.sdp)
        .length;
      pc.transceivers.forEach(function (transceiver, sdpMLineIndex) {
    ...
    if (
      ...
      reject(
        new AxiosError_1(
          ...
          [AxiosError_1.ERR_BAD_REQUEST, AxiosError_1.ERR_BAD_RESPONSE][
    ...
    return new Promise(function dispatchXhrRequest(resolve, reject) {
      ...
      if (config.cancelToken || config.signal) {
        ...
        onCanceled = function (cancel) {
          ...
          reject(
            !cancel || (cancel && cancel.type) ? new CanceledError_1() : cancel
          );
          request.abort();
          request = null;
        };
  ...
  function GetSupportCameraResolutions$1() {
    return new Promise(function (resolve, reject) {
      ...
      for (let i = 0; i < quickScan.length; ++i) {
        let videoConstraints = new VideoTrackConstraints(
  ...
  export const Events = Events$1;
export const Media = media;
export const Endpoint = RTCEndpoint;
export const GetSupportCameraResolutions = GetSupportCameraResolutions$1;
export const GetAllScanResolution = GetAllScanResolution$1;
export const isSupportResolution = isSupportResolution$1;
